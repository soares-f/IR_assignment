...
querydir = "Consultas_new_small.txt"
...
for s in soup('top'):
	...
	# media geometrica entre (word2vec+distance correlation) e Xapian
	score_final = (dist_scores*score_final)**(1/2)
	# ranking final da consulta
	ranking_final = numpy.argsort(score_final[::-1])
